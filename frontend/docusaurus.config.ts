...
const config: Config = {
  ...
  tagline: 'Creating a book with AI and Spec-Kit Plus',
  ...
  projectName: 'Book-Gemini', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/mromankhan/Book-Gemini/tree/001-interactive-book-chatbot/frontend/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/mromankhan/Book-Gemini',
          label: 'GitHub',
          position: 'right',
        },
      ],
